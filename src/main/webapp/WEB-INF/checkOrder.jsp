...
<body>
	...
	<div class="message">
				...
				<c:forEach items="${list_address}" var="addr">
					<div class="msg_addr">
						...
						<span class="msg_right">
							${addr.dzMch}}<input onclick="show_address('${addr.dzMch}${addr.shjr}${addr.lxfsh}')" type="radio" name="id" value="${addr.id}"/>
						</span>
					</div>
				</c:forEach>
			</form>
			...
			<div class="msg_title">
				...
				<c:forEach items="${order.listflow}" var="flow" >
					...
					<div class="msg_list">
						...
						<div class="msg_list_right">
							<div class="msg_img">
								<img width="80px"  height="80px" src="upload/image/${info.shpTp}"/>
							</div>
							<div class="msg_name">
								${info.skuMch}
							</div>
